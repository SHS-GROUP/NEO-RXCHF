C======================================================================
      subroutine GAM1_OMP_MD(nebf,npebf,npbf,ng1,ng1prm,nat,ngtg1,
...
C======================================================================
      subroutine xcalc_GAM1_MD(I1,J1,K1,A1,Amat1,
     x                         I2,J2,K2,A2,Amat2,
     x                         L1,M1,N1,B1,Bmat1,
     x                         L2,M2,N2,B2,Bmat2,
     x                         nat,ngtg1,
...
C
         VCEGX=VCEGX+BCFV*VCEGXI
         VCPGX=VCPGX+BCFV*VCPGXI
         VMGX=VMGX+BCFV*VMGXI
C
         CALL PGIKE1(I1,J1,K1,A1,Amat1,
     1               I2,J2,K2,A2,Amat2,
     2               L1,M1,N1,B1,Bmat1,
