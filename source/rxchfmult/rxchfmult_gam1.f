...
C======================================================================
      subroutine RXCHFmult_xcalc_GAM1_MD(I1,J1,K1,A1,Amat1,
     x                                   I2,J2,K2,A2,Amat2,
     x                                   L1,M1,N1,B1,Bmat1,
     x                                   L2,M2,N2,B2,Bmat2,
     x                                   nat,ngtg1,
...
C
      DO K=1,NGTG1
         ...
         BCFV=BCOEF1(K)
CC 
Cc     SUBROUTINE pgike1(I1,J1,K1,alp1,Amat1,
Cc    1                  I2,J2,K2,alp2,Amat2,
Cc    2                  L1,M1,N1,beta1,Bmat1,
Cc    3                  L2,M2,N2,beta2,Bmat2,
Cc    4                  gamA,gamB,xmass1,ans,sval)
C
...
Cc    5               ogxix,ogxiy,ogxiz)
Cc        write(*,*)'electronic kinetic gx integral = ',tegxi
CC
...
Cc    5               ogxix,ogxiy,ogxiz)
CC
Cc        OGX=OGX+BCFV*OGXIX*OGXIY*OGXIZ
...
C            ZNUC=ZAN(III)
CC
Cc           CALL PGIVEC(I1,J1,K1,A1,Amat1,
Cc    1                  I2,J2,K2,A2,Amat2,
Cc    2                  L1,M1,N1,B1,Bmat1,
Cc    3                  L2,M2,N2,B2,Bmat2,
Cc    4                  GV,zero,CMAT,VCEGXIA)
Cc           VCEGXI=VCEGXIA*ZNUC+VCEGXI
Cc           write(*,*)'AC:  VCEGXIA=',VCEGXIA
...
Cc           write(*,*)'MD:  VCEGXIA=',VCEGXIA
Cc           write(*,*)
C
CC
Cc           CALL PGIVEC(I2,J2,K2,A2,Amat2,
Cc    1                  I1,J1,K1,A1,Amat1,
Cc    2                  L2,M2,N2,B2,Bmat2,
Cc    3                  L1,M1,N1,B1,Bmat1,
Cc    4                  GV,zero,CMAT,VCPGXIA)
Cc           VCPGXI=VCPGXIA*ZNUC+VCPGXI
...
C         END DO
CC
Cc        CALL PGIVEE(I1,J1,K1,A1,Amat1,
Cc    1               I2,J2,K2,A2,Amat2,
Cc    2               L1,M1,N1,B1,Bmat1,
Cc    3               L2,M2,N2,B2,Bmat2,
Cc    4               GV,ZERO,VMGXI)
...
Cc    5               dum1,dum2,dum3)
Cc        write(*,*)'electronic kinetic xg integral = ',texgi
CC
C         CALL PGIKE1(I2,J2,K2,A2,Amat2,
C     1               I1,J1,K1,A1,Amat1,
C     2               L2,M2,N2,B2,Bmat2,
...
C
      DO K=1,NGTG1
         ...
         BCFV=BCOEF1(K)
CC 
Cc        call pgiovlap_1D(I1,A1,amat1(1),
Cc    &                    I2,A2,amat2(1),
Cc    &                    L1,B1,bmat1(1),
Cc    &                    L2,B2,bmat2(1),
Cc    &                    GV,zero,OGXIX)
C
Cc        call pgiovlap_1D(J1,A1,amat1(2),
Cc    &                    J2,A2,amat2(2),
Cc    &                    M1,B1,bmat1(2),
Cc    &                    M2,B2,bmat2(2),
Cc    &                    GV,zero,OGXIY)
C
Cc        call pgiovlap_1D(K1,A1,amat1(3),
Cc    &                    K2,A2,amat2(3),
Cc    &                    N1,B1,bmat1(3),
Cc    &                    N2,B2,bmat2(3),
Cc    &                    GV,zero,OGXIZ)
