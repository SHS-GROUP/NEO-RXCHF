C=======================================================================
      subroutine RXCHFmult_FAE_OMG2ex(Nchunks,nebf,npbf,ng2,
     x                                DAE,DBE,DP,
     x                                GM2ICR,GM2exICR,
     x                                FAE,E_AE_OMG2)
...
C Nested loop compression for this chunk:
         ...
         call RXCHFmult_thread_FAE_OMG2ex(istart,iend,ng2_seg,
     x                                    ng2,nebf,npbf,
...
C======================================================================
      subroutine RXCHFmult_thread_FAE_OMG2ex(istart,iend,ng2_seg,
     x                                       ng2,nebf,npbf,
     x                                       loop_map,DAE,DBE,DP,
     x                                       GM2ICR,GM2exICR,
     x                                       XFAE,E_AE_OMG2)
...
!$omp do SCHEDULE(RUNTIME)
      do iLP=istart,iend
         ...
         val=GM2ICR(ia_12)-half*GM2exICR(ia_21)
...
C=======================================================================
      subroutine RXCHFmult_FP_OMG2ex(Nchunks,nebf,npbf,ng2,
     x                               DAE,DBE,DP,
     x                               GM2ICR,GM2exICR,
     x                               FP,E_P_OMG2)
...
C Nested loop compression for this chunk:
         ...
         call RXCHFmult_thread_FP_OMG2ex(istart,iend,ng2_seg,
     x                                   ng2,nebf,npbf,
     x                                   loop_map,DAE,DBE,DP,
     x                                   GM2ICR,GM2exICR,
     x                                   XFP,E_P_OMG2)
...
C======================================================================
      subroutine RXCHFmult_thread_FP_OMG2ex(istart,iend,ng2_seg,
     x                                      ng2,nebf,npbf,
     x                                      loop_map,DAE,DBE,DP,
     x                                      GM2ICR,GM2exICR,
     x                                      XFP,E_P_OMG2)
...
C=======================================================================
      subroutine RXCHFmult_FBE_OMG2ex(Nchunks,nebf,npbf,ng2,
     x                                DAE,DBE,DP,
     x                                GM2ICR,GM2exICR,
     x                                FBE,E_BE_OMG2)
...
C Nested loop compression for this chunk:
         ...
         call RXCHFmult_thread_FBE_OMG2ex(istart,iend,ng2_seg,
     x                                    ng2,nebf,npbf,
     x                                    loop_map,DAE,DBE,DP,
     x                                    GM2ICR,GM2exICR,
     x                                    XFBE,E_BE_OMG2)
...
C======================================================================
      subroutine RXCHFmult_thread_FBE_OMG2ex(istart,iend,ng2_seg,
     x                                       ng2,nebf,npbf,
     x                                       loop_map,DAE,DBE,DP,
     x                                       GM2ICR,GM2exICR,
     x                                       XFBE,E_BE_OMG2)
