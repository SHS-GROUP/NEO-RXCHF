...
C Add OMG2 contributions to all Fock matrices
C=======================================================================
      implicit none
      include 'mpif.h'
...
C Update Fock matrices
      call MPI_ALLREDUCE(XFAE,FAE,nebf*nebf,
     x                   MPI_DOUBLE_PRECISION,MPI_SUM,
     x                   MPI_COMM_WORLD,ierr)
      call MPI_ALLREDUCE(XFBE,FBE,nebf*nebf,
     x                   MPI_DOUBLE_PRECISION,MPI_SUM,
     x                   MPI_COMM_WORLD,ierr)
      call MPI_ALLREDUCE(XFP,FP,npbf*npbf,
     x                   MPI_DOUBLE_PRECISION,MPI_SUM,
     x                   MPI_COMM_WORLD,ierr)
...
C Add OMG2 (incl exchange) contributions to all Fock matrices
C=======================================================================
      implicit none
      include 'mpif.h'
