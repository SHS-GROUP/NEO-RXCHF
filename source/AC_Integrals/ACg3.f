...
C
      ...
      do i=1,NDIM
CCWS(  call G3gprod_1D(p1,c13,Pmat3(i),Pmat3(i),t1,s1,Tmat1(i),Smat1(i))
       call G3gprod_1D(p1,c13,Pmat1(i),Pmat3(i),t1,s1,Tmat1(i),Smat1(i))
CCWS)
       call G3gprod_1D(p2,c23,Pmat2(i),Pmat3(i),t2,s2,Tmat2(i),Smat2(i))
      end do
