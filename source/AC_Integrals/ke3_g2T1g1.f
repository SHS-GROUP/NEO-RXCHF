C*****************************************************************
      SUBROUTINE G3ke_g2T1g1(I1,J1,K1,alp1,Amat1,
...
C <GA(1)GA(2)GA(3)g(2,3)|T(1)|GB(1)GB(2)GB(3)g(1,3)>
C
...
C--------------Laplacian--------------------
      call G3Lap_1D_g2T1g1(I1,alp1,Amat1(1),
     1                I2,alp2,Amat2(1),
     1                I3,alp3,Amat3(1),
     2                L1,beta1,Bmat1(1),
     3                L2,beta2,Bmat2(1),
     ...
     6                gamB12,gamB13,gamB23,DELTA,ddx)
      ...
      call G3Lap_1D_g2T1g1(J1,alp1,Amat1(2),
     1                J2,alp2,Amat2(2),
     1                J3,alp3,Amat3(2),
     2                M1,beta1,Bmat1(2),
     3                M2,beta2,Bmat2(2),
     ...
     6                gamB12,gamB13,gamB23,DELTA,ddy)
      ...
      call G3Lap_1D_g2T1g1(K1,alp1,Amat1(3),
     1                K2,alp2,Amat2(3),
     1                K3,alp3,Amat3(3),
     2                N1,beta1,Bmat1(3),
     3                N2,beta2,Bmat2(3),
...
C*****************************************************************
      SUBROUTINE G3Lap_1D_g2T1g1(I1,alp1,Amat1,
     1                    I2,alp2,Amat2,
     1                    I3,alp3,Amat3,
     2                    L1,beta1,Bmat1,
     3                    L2,beta2,Bmat2,
...
C*****************************************************************
C Solve
C <GA(1)GA(2)GA(3)g(2,3)|d^2/dx1^2|GB(1)GB(2)GB(3)g(1,3)>
C
...
C===================================================================================
C overlap integral
C S1(-Delta) = <GA(1)GA(2)GA(3)g(2,3)|GB(1+DELTA)GB(2)GB(3)g(1+DELTA,3)>
      coef = -1.0d0
      AM1  = Amat1 + (coef*Delta)

      call G3ovlap_1D(I1,alp1,AM1,
     1                I2,alp2,Amat2,
     1                I3,alp3,Amat3,
     2                L1,beta1,Bmat1,
     3                L2,beta2,Bmat2,
     4                L3,beta3,Bmat3,
     5                ZERO,ZERO,gamA23,
     6                ZERO,gamB13,ZERO,S1)
C----------------------------------------------------------------
C S2(0) = <GA(1)GA(2)GA(3)g(2,3)|GB(1+DELTA)GB(2)GB(3)g(1+DELTA,3)>
      coef = 0.0d0
      AM1  = Amat1 + (coef*Delta)
     ...
     4                L3,beta3,Bmat3,
     5                ZERO,ZERO,gamA23,
     6                ZERO,gamB13,ZERO,S2)
C----------------------------------------------------------------
C S3(Delta) = <GA(1)GA(2)GA(3)g(2,3)|GB(1-DELTA)GB(2)GB(3)g(1-DELTA,3)>
      coef = 1.0d0
      AM1  = Amat1 + (coef*Delta)
...
C===================================================================================
C     write(*,*)'======================================================'
C     write(*,*)'   OUTPUT FROM ke3_g2T1g1   '
C     write(*,*)'======================================================'
C     write(*,*) 'FORMAT I alp cent '
C     write(*,*) 'GA(1)  ',I1,alp1,Amat1
C     write(*,*) 'GA(2)  ',I2,alp2,Amat2
C     write(*,*) 'GA(3)  ',I3,alp3,Amat3
C     write(*,*) 'g(2,3) ',gamA23
C     write(*,*) 'GB(1)  ',L1,beta1,Bmat1
C     write(*,*) 'GB(2)  ',L2,beta2,Bmat2
C     write(*,*) 'GB(3)  ',L3,beta3,Bmat3
C     write(*,*) 'g(1,3) ',gamB13
C     write(*,*) 'S1  ',S1
C     write(*,*) 'S2  ',S2
C     write(*,*) 'S3  ',S3
C     write(*,*) '***ANS*** ',ans
