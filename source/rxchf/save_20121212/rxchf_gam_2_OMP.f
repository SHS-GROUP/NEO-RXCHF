C======================================================================
      subroutine RXCHF_GAM2_OMP_MD(nebf,npebf,npbf,ng2,ng2prm,nat,ngtg1,
...
c    x                                     bcoef1,gamma1,
c    x                                     ansE,ansS)
         call RXCHF_xcalc_GAM2_MD(I1,J1,K1,A1,Amat1,
     x                      I2,J2,K2,A2,Amat2,
     x                      I3,J3,K3,A3,Amat3,
     x                      L1,M1,N1,B1,Bmat1,
     x                      L2,M2,N2,B2,Bmat2,
...
C======================================================================
      subroutine RXCHF_xcalc_GAM2_MD(I1,J1,K1,A1,Amat1,
     x                         I2,J2,K2,A2,Amat2,
     x                         I3,J3,K3,A3,Amat3,
     x                         L1,M1,N1,B1,Bmat1,
     x                         L2,M2,N2,B2,Bmat2,
...
C      double precision gVEP     
      ...
      double precision xgVECg3     
      double precision xgVEPg1     
      double precision xgVEPg2     
      double precision xgVEPg3     
      ...
      double precision gVECg3     
      double precision gVEPg1     
      double precision gVEPg2     
      double precision gVEPg3     
...
C             xgTEg2 (2,3) (1,3)
C-RXCHFexch---g(e1,p1) T^e(e2) g(e2,p1)--
C           --gA(1,3) T^e(2) gB(2,3)--
C           --gA(2,3) T^e(1) gB(1,3)--RXCHFexch-
            call zero_gam(gamA12,gamA13,gamA23,
     *                    gamB12,gamB13,gamB23)
            gamA23=GAMMA1(IK)
            gamB13=GAMMA1(IL)
            xmass=1.0d+00
            call G3_MD_KE(I2,J2,K2,A2,Amat2,
     *                    I1,J1,K1,A1,Amat1,
     *                    I3,J3,K3,A3,Amat3,
     *                    L2,M2,N2,B2,Bmat2,
     *                    L1,M1,N1,B1,Bmat1,
...
C             xgTEg3 (2,3) (2,3)
C-RXCHFexch---g(e1,p1)T^e(e2)g(e1,p1)--
C           --gA(1,3) T^e(2) gB(1,3)--
C           --gA(2,3) T^e(1) gB(2,3)--RXCHFexch-
            call zero_gam(gamA12,gamA13,gamA23,
     *                    gamB12,gamB13,gamB23)
            gamA23=GAMMA1(IK)
            gamB23=GAMMA1(IL)
...
C              xgVECg2 (2,3)  (2,3)
C-RXCHFexch------g(e1,p1) V^{eC}(e2) g(e2,p1)--
C              --gA(1,3) V^{eC}(2) gB(2,3)--
C              --gA(2,3) V^{eC}(1) gB(1,3)--RXCHFexch-
               call zero_gam(gamA12,gamA13,gamA23,
     *                       gamB12,gamB13,gamB23)
               gamA23=GAMMA1(IK)
               gamB13=GAMMA1(IL)

               call G3_MD_xgVxCg(I2,J2,K2,A2,Amat2,
     *                           I1,J1,K1,A1,Amat1,
     *                           I3,J3,K3,A3,Amat3,
     *                           L2,M2,N2,B2,Bmat2,
     *                           L1,M1,N1,B1,Bmat1,
...
C              xgVECg3 (2,3)  (2,3)
C-RXCHFexch------g(e1,p1) V^{eC}(e2) g(e1,p1)--
C              --gA(1,3) V^{eC}(2) gB(1,3)--
C              --gA(2,3) V^{eC}(1) gB(2,3)--RXCHFexch-
               call zero_gam(gamA12,gamA13,gamA23,
     *                       gamB12,gamB13,gamB23)
               gamA23=GAMMA1(IK)
               gamB23=GAMMA1(IL)
...
C           xgVEPg2  (2,3) (1,2)
C-RXCHFexch---g(e1,p1) V^{ep}(e2,p1) g(e2,p1)--
C           --gA(1,3) V^{ep}(2,3) gB(2,3)--
C           --gA(1,2) V^{ep}(3,2) gB(3,2)--
C           --gA(3,2) V^{ep}(1,2) gB(1,2)--RXCHFexch-
            call zero_gam(gamA12,gamA13,gamA23,
     *                    gamB12,gamB13,gamB23)
            gamA23=GAMMA1(IK)
            gamB12=GAMMA1(IL)

            call G3_MD_xgVeeg(I2,J2,K2,A2,Amat2,
     *                        I3,J3,K3,A3,Amat3,
     *                        I1,J1,K1,A1,Amat1,
     *                        L2,M2,N2,B2,Bmat2,
     *                        L3,M3,N3,B3,Bmat3,
...
C           xgVEPg3  (2,3) (2,3)
C-RXCHFexch---g(e1,p1) V^{ep}(e2,p1) g(e1,p1)--
C           --gA(1,3) V^{ep}(2,3) gB(1,3)--
C           --gA(1,2) V^{ep}(3,2) gB(1,2)--
C           --gA(3,2) V^{ep}(1,2) gB(3,2)--RXCHFexch-
            call zero_gam(gamA12,gamA13,gamA23,
     *                    gamB12,gamB13,gamB23)
            gamA23=GAMMA1(IK)
            gamB23=GAMMA1(IL)
...
C  Sum up 2 gamma loop terms
            ...
            gVECg3=gVECg3+bcoef1(ik)*bcoef1(iL)*xgVECg3

            gVEPg1=gVEPg1+bcoef1(ik)*bcoef1(iL)*xgVEPg1
            gVEPg2=gVEPg2+bcoef1(ik)*bcoef1(iL)*xgVEPg2
            gVEPg3=gVEPg3+bcoef1(ik)*bcoef1(iL)*xgVEPg3
...
C sum of terms: 
C ARS( energy partition
C      ansE1 = gTEg3 + gVECg3
C     x      + gVEPg3
C     x      + gVEEg1
C
C      ansE2 = gTPg + gVPCg
