!=======================================================================
      subroutine RXCHF_GAM2_IC1(Nchunks,nebf,npebf,npbf,
...
! Variables Returned
      double precision GM2_1ICR(ng2)  ! OMG_2^{(1)} integrals (unsymm)
      double precision GM2_2ICR(ng2)  ! OMG_2^{(2)} integrals (symm)
      double precision GM2sICR(ng2)   ! OMG_{2s}    integrals (symm?)
...
C        end if
C )
         call RXCHF_thread_gam2_IC1(istart,iend,ng2_seg,ng2,
...
C Unsymmetrized integrals in GM2_1ICR
                       x12=XG2_1ICR(ia_12)
                       GM2_1ICR(ia_12)=x12

C Symmetrized integrals in GM2_2ICR
                       x12=XG2_2ICR(ia_12)
                       x21=XG2_2ICR(ia_21)
                       GM2_2ICR(ia_12)=(x12+x21)/two

C Symmetrized integrals in GM2sICR
                       x12=XG2sICR(ia_12)
                       x21=XG2sICR(ia_21)
...
!=======================================================================
      subroutine RXCHF_thread_gam2_IC1(istart,iend,ng2_seg,ng2,
     x                           nebf,npebf,npbf,nat,ngtg1,
     x                           pmass,cat,zan,bcoef1,gamma1,
     x                           loop_map,XG2_1ICR,XG2_2ICR,XG2sICR,
     x                           KPESTR,KPEEND,AMPEB2C,AGEBFCC,AGNBFCC,
...
!        imap=iLp
         ...
         call RXCHF_contract_omega2_conv(ip,jp,iec1,jec1,iec2,jec2,
     x                             nebf,npebf,npbf,nat,ngtg1,
     x                             pmass,cat,zan,bcoef1,gamma1,
     x                            KPESTR,KPEEND,AMPEB2C,AGEBFCC,AGNBFCC,
     x                            ELCEX,NUCEX,ELCAM,NUCAM,ELCBFC,NUCBFC,
