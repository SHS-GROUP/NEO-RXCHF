...
! Nested loop compression for this chunk:
     ...
     x                   loop_map,DAE,DBE,DP,GM3_1ICR,GM3_2ICR,
     x                   XFAE,E_AE_OMG3)
...
!$omp do SCHEDULE(RUNTIME)
     ...
     x                  ip,jp,iec1,jec3,iec2,jec2,iec3,jec1,ia_123_321)
         ...
         val1=GM3_1ICR(ia_123_123)-half*GM3_1ICR(ia_123_132)
C         val2=GM3_2ICR(ia_123_213)-half*GM3_2ICR(ia_123_312)
C         val3=GM3_2ICR(ia_123_321)-half*GM3_2ICR(ia_123_231)
C
C      XFAE(iec2,jec2)=XFAE(iec2,jec2)+
C     x                DAE(iec3,jec3)*DBE(iec1,jec1)*DP(ip,jp)
C     x               *(two*val1-val2-val3)
C
C      E_AE_OMG3 = E_AE_OMG3 + half*DP(ip,jp)*DBE(iec1,jec1)
C     x               *DAE(iec2,jec2)*DAE(iec3,jec3)
C     x               *(val1-val2)
     ...
     x                  ip,jp,iec1,iec2,iec3,jec1,jec2,jec3,ib_132_213)
         ...
         val2=(GM3_2ICR(ia_123_213)+GM3_2ICR(ib_123_213))
     x         -half*(GM3_2ICR(ia_123_312)+GM3_2ICR(ib_123_312))
         val3=(GM3_2ICR(ia_132_312)+GM3_2ICR(ib_132_312))
     x         -half*(GM3_2ICR(ia_132_213)+GM3_2ICR(ib_132_213))

      XFAE(iec2,jec2)=XFAE(iec2,jec2)+
     x                DAE(iec3,jec3)*DBE(iec1,jec1)*DP(ip,jp)
     x               *(two*val1-half*(val2+val3))
...
!$omp do SCHEDULE(RUNTIME)
     ...
     x                      ip,jp,iec1,jec3,iec2,jec2,iec3,jec1,ia_321)
         ...
         val3=GM3_2ICR(ia_321)-half*GM3_2ICR(ia_231)
