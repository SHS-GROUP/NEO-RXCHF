...
! Variables Returned
      double precision GM3_1ICR(ng3),GM3_2ICR(ng3),GM3_3ICR(ng3)
...
! Nested loop compression for this chunk:
     ...
     x                        pmass,cat,zan,bcoef1,gamma1,
     x                        loop_map,XG3_1ICR,XG3_2ICR,XG3_3ICR,
     x                        KPESTR,KPEEND,AMPEB2C,AGEBFCC,AGNBFCC,
     x                        ELCEX,NUCEX,ELCAM,NUCAM,ELCBFC,NUCBFC)
...
C Unsymmetrized integrals in GM3_1ICR
...
C Symmetrized integrals in GM3_2ICR
                       ...
                       x213=XG3_2ICR(ia_213)
                       x231=XG3_2ICR(ia_231)
                       x312=XG3_2ICR(ia_312)
                       x321=XG3_2ICR(ia_321)
                       xxxx=(x123+x132+x213+x231+x312+x321)/six

                       GM3_2ICR(ia_123)=xxxx 
                       GM3_2ICR(ia_132)=xxxx 
                       GM3_2ICR(ia_213)=xxxx 
                       GM3_2ICR(ia_231)=xxxx 
                       GM3_2ICR(ia_312)=xxxx 
                       GM3_2ICR(ia_321)=xxxx 

C Symmetrized integrals in GM3_3ICR
                       x123=XG3_3ICR(ia_123)
                       x132=XG3_3ICR(ia_132)
                       x213=XG3_3ICR(ia_213)
                       x231=XG3_3ICR(ia_231)
                       x312=XG3_3ICR(ia_312)
                       x321=XG3_3ICR(ia_321)
                       xxxx=(x123+x132+x213+x231+x312+x321)/six

                       GM3_3ICR(ia_123)=xxxx 
                       GM3_3ICR(ia_132)=xxxx 
                       GM3_3ICR(ia_213)=xxxx 
                       GM3_3ICR(ia_231)=xxxx 
                       GM3_3ICR(ia_312)=xxxx 
                       GM3_3ICR(ia_321)=xxxx 
...
C                       xxxx=(x123+x132+x213+x312)*half*half
C
...
C Symmetrized integrals in GM3_3ICR
C                       x231=XG3_3ICR(ia_231)
C                       x321=XG3_3ICR(ia_321)
C                       xxxx=(x231+x321)*half

C                       GM3_3ICR(ia_231)=xxxx 
C                       GM3_3ICR(ia_321)=xxxx 
C                       GM3_3ICR(ia_231)=0.0d0
C                       GM3_3ICR(ia_321)=0.0d0
...
C-------Basis Set Info-------)
      ...
      double precision XG3_1ICR(ng3),XG3_2ICR(ng3),XG3_3ICR(ng3)
...
!$ompx shared(XG3_1ICR,XG3_2ICR,XG3_3ICR)
...
!$ompx private(ia) 
!$ompx private(OMG3_1,OMG3_2,OMG3_3)
!$ompx private(id)
