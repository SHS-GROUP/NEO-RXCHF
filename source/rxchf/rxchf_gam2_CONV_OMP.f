!=======================================================================
      subroutine RXCHF_GAM2_CONV(Nchunks,nebf,npebf,npbf,
...
!        call thread_gam2_conv(my1st,mylast,ng2_seg,ng2,
         call RXCHF_thread_gam2_conv(istart,iend,ng2_seg,ng2,
...
C=======================================================================
      subroutine RXCHF_thread_gam2_conv(istart,iend,ng2_seg,ng2,
     x                            nebf,npebf,npbf,nat,ngtg1,
     x                            pmass,cat,zan,bcoef1,gamma1,
...
!======================================================================
      subroutine RXCHF_contract_omega2_conv(ip,jp,
