...
c
      subroutine inv(v,w)
c
c     compute the inverse of the 2x2 matrix v
c     in:  v
c     out: w
c
      real*8 v(2,2),w(2,2),det
c
c     compute determinant of v
c
      det=v(1,1)*v(2,2)-v(1,2)*v(2,1)
      write(*,*)'det=',det
c
c     compute w - the inverse of v
c
      w(1,1)=v(2,2)/det
      w(1,2)=-v(1,2)/det
      w(2,1)=-v(2,1)/det
...
c
C======================================================================
c     real*8 v(2,2),w(2,2),det
c
c     compute determinant of v
c
c     det=v(1,1)*v(2,2)-v(1,2)*v(2,1)
c     write(*,*)'det=',det
c
c     compute w - the inverse of v
c
